...
public class TodoService {
	...
	public void addTodo(String username, String description, LocalDate targetDat, boolean done)
	{
		Todo todo = new Todo(++todosCount, username, description, targetDat, done);
		todos.add(todo);
